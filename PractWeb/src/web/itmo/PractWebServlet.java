...
public class PractWebServlet extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		case 1:
			...
			resp.getWriter().println(ClosestTo10(i1, i2, operation));
			break;
		case 2:
		...
		case 6:
			...
			break;
		case 7:
			String weather_s = req.getParameter("weather");
			Boolean weather = Boolean.parseBoolean(weather_s);
			String inventory_s = req.getParameter("inventory");
			Boolean inventory = Boolean.parseBoolean(inventory_s);
			String season = req.getParameter("season");
			Son son = new Son();
			resp.getWriter().println(son.eating(weather, season, inventory));
			//resp.getWriter().println(inventory);
			
		}
		
	}
	public int ClosestTo10(int i1, int i2, String operation){
		int result;
